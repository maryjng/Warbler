...
def users_likes(user_id):
    """Display liked messages for user"""
...
def add_like(message_id):
    """Toggle like for message for current user"""
    ...
    if msg.user_id == g.user.id:
        flash("Unfortunately, you can't like your own posts.")
...
def homepage():
    ...
    - logged in: 100 most recent messages of user and its followed_users
    """
    ...
    if g.user:
        ...
        msg_ids = [msg.id for msg in user.likes]

        return render_template('home.html', messages=messages, likes=msg_ids)
